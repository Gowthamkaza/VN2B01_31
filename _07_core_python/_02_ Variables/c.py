...
if __name__ == '_main_':
    ...
    class InputFormsCheck(unittest.TestCase):
        ...
        # Opening browser.
        def setUp(self):
            self.driver = webdriver.Chrome(r'""C:\Users\DEEL\Downloads\chromedriver.exe""')
    ...
    # This line sets the variable “_name” to have a value “main_”.
    # If this file is being imported from another module then “_name_” will be set to the other module's name.
    if __name__ == "_main_":
        unittest.main()