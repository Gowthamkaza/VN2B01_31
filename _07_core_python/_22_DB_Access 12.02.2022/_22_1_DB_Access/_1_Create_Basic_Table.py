...
try:
    ...
    query = "CREATE TABLE gowtham1(filename VARCHAR(20) PRIMARY KEY, filesize VARCHAR(20), extension VARCHAR(20), uploadedtime VARCHAR(20), uploadedby VARCHAR(20), sub_files_ext VARCHAR(20),Files_count VARCHAR(20))"
